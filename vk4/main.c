...
/* //Viikkotehtävä 4 3p suoritus
* Sekvenssin kokonaisaika lasketaan aina sekvenssin lopuksi riippumatta siitä mitä kautta sekvenssi on annettu.
* Debug taskin tulostukset voidaan laittaa päälle ja pois painamalla D-näppäintä UARTin kautta.
* Asser-tarkistukset dispatcher ja debug taskeissa. (prj.conf -> CONFIG_ASSERT=y)
* 
